...
- **Zero-Overhead Foundation:** Built using raw Python, Pydantic for type-safe agent configuration and validation, and the official Ollama library, completely eliminating unnecessary middleware overhead.
